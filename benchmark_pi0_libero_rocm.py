...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # Use scaled_dot_product_attention for optimized kernels on ROCm
...
def main():
    ...
    parser.add_argument("--vision-hidden-dim", type=int, default=2048, help="Vision transformer hidden dim")
    parser.add_argument("--vision-num-layers", type=int, default=18, help="Vision transformer layers")
    ...
    parser.add_argument("--action-hidden-dim", type=int, default=1024, help="Action transformer hidden dim")
    parser.add_argument("--action-num-layers", type=int, default=18, help="Action transformer layers")
